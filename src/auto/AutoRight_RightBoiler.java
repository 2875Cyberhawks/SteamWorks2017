...
public class AutoRight_RightBoiler extends CommandGroup{
	public AutoRight_RightBoiler(){
		addSequential(new CmdDriveDistance(82 ,.6));
		addSequential(new CmdRotateAngle(40, .4, 0));
		...
		addSequential(new CmdRotateAngle(49, .4, 1));
		addSequential(new CmdDriveDistance(47 ,.6));
		//addSequential(new CmdRotateAngle(358, .8, 0));//xd
		
		addSequential(new CmdRotateAngle(90, .4, 0));
		addSequential(new CmdDriveDistanceCam(24, .4, 3));
		addSequential(new CmdDriveDistance(16, .4));
		*/
